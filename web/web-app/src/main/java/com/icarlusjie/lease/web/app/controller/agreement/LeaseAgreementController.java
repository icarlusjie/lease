package com.icarlusjie.lease.web.app.controller.agreement;
...
import com.icarlusjie.lease.web.app.service.LeaseAgreementService;
import com.icarlusjie.lease.web.app.vo.agreement.AgreementDetailVo;
import com.icarlusjie.lease.web.app.vo.agreement.AgreementItemVo;
...
public class LeaseAgreementController {
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam LeaseStatus leaseStatus) {
        ...
        agreementLambdaUpdateWrapper.eq(LeaseAgreement::getId,id);
        agreementLambdaUpdateWrapper.set(LeaseAgreement::getStatus,leaseStatus);
        service.update(agreementLambdaUpdateWrapper);
        return Result.ok();
    }
